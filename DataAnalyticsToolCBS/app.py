...
def login_page():
    ...
    st.markdown("""
        <div class='telenor-logo'>
            <div class='telenor-logo-box'>
                <span class='telenor-text'>⚡ TELENOR</span>
            </div>
        </div>
    """, unsafe_allow_html=True)
    ...
    # Project Phoenix with animation
    ...
    with col2:
        with st.container():
            ...
            st.markdown("<p class='welcome-text'>Please sign in to continue to your dashboard</p>", unsafe_allow_html=True)
    ...
    st.markdown("""
        <div class='login-footer'>
            <p>© 2025 Project Phoenix - Bug Management System</p>
            <p style='font-size: 12px; margin-top: 5px;'>Powered by Telenor Technology</p>
        </div>
    """, unsafe_allow_html=True)
